...
# $referer		[string]
#	$conttype = "http://www.donate2educate.com/";
...
function func_https_request($method, $url, $data="", $join="&", $cookie="", $conttype="application/x-www-form-urlencoded", $referer="", $cert="", $kcert="", $headers="")
{
